...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        ...
        <div class="flex items-center">
            ...
            <div class="ml-4">
                <h1 class="text-2xl font-bold text-gray-900">Edit Jadwal Praktik</h1>
                <p class="text-sm text-gray-600 mt-1">Perbarui jadwal praktik Anda</p>
            </div>
        </div>
    </div>
                ...
                <div class="mb-8">
                    ...
                    <div class="relative">
                        ...
                        <select name="slot_duration" id="slot_duration" required
                            ...
                            <option value="15" {{ old('slot_duration', $schedule->slot_duration) == 15 ? 'selected' : '' }}>15 menit</option>
                            <option value="30" {{ old('slot_duration', $schedule->slot_duration) == 30 ? 'selected' : '' }}>30 menit</option>
                            <option value="45" {{ old('slot_duration', $schedule->slot_duration) == 45 ? 'selected' : '' }}>45 menit</option>
                            <option value="60" {{ old('slot_duration', $schedule->slot_duration) == 60 ? 'selected' : '' }}>60 menit</option>
                        </select>
                        <div class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                            <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
    ...
    <div class="bg-blue-50 border border-blue-200 rounded-xl p-4">
        <div class="flex">
            ...
            <div>
                <h3 class="text-sm font-semibold text-blue-900 mb-1">Perhatian</h3>
                <p class="text-sm text-blue-700">Perubahan jadwal akan mempengaruhi slot booking yang tersedia untuk pasien. Pastikan tidak ada janji temu yang sudah dibuat pada waktu yang akan diubah.</p>
            </div>
        </div>
    </div>
</div>
