    ...
    <div class="max-w-3xl mx-auto">
        ...
        <div class="mb-8">
            ...
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <h1 class="text-3xl font-bold text-gray-900">Tambah Spesialisasi</h1>
                    <p class="text-sm text-gray-600 mt-1">Buat spesialisasi dokter baru</p>
                </div>
            </div>
        </div>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="relative">
                            <textarea name="description" 
                                      ...
                                      placeholder="Jelaskan tentang spesialisasi ini...">{{ old('description') }}</textarea>
                        </div>
