...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        ...
        <div class="flex items-center">
            ...
            <div class="ml-4">
                ...
                <p class="text-sm text-gray-600 mt-1">Perbarui informasi user: <strong>{{ $user->name }}</strong></p>
            </div>
        </div>
    </div>
            ...
            <form method="POST" action="{{ route('admin.users.reset-password', $user) }}">
                ...
                <div class="mt-4">
                    <button type="submit" 
                            ...
                            class="inline-flex items-center px-5 py-2.5 bg-yellow-600 hover:bg-yellow-700 text-white font-semibold rounded-lg transition-colors">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="bg-blue-50 border border-blue-200 rounded-xl p-4">
        <div class="flex">
            ...
            <div>
                <h3 class="text-sm font-semibold text-blue-900 mb-1">Catatan</h3>
                <ul class="text-sm text-blue-700 space-y-1">
                    <li>• Password tidak akan diubah jika field reset password tidak diisi</li>
                    <li>• Pastikan role yang dipilih sesuai dengan fungsi user</li>
                    <li>• Perubahan data akan langsung disimpan ke database</li>
                </ul>
            </div>
        </div>
    </div>
